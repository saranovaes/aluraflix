  ...
  return (
    <>
      <StyledFooter>
        ...
        <Container>
          <TextFooter>
            Criado por Sara Novaes- 2023/
            programa "ONE - Oracle Next Education".
          </TextFooter>

          <NavStyled>
            <NavItem to="https://www.linkedin.com/in/sara-novaes-dev-front" target="_blank">
              <IconLinkedin />
            </NavItem>
            <NavItem to="https://github.com/saranovaes" target="_blank">
              <IconGithub />
            </NavItem>
          </NavStyled>
        </Container>
